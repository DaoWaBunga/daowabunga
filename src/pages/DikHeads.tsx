...
import Mint from './DikHeads/Mint';
import Description from './DikHeads/Description';
import DisplayWallet from './DikHeads/Wallet';
import BodyPadding from '../layouts/BodyPadding';
import { useState } from 'react';
import { CgMenuBoxed } from 'react-icons/cg';
import Transitions from './DikHeads/Transitions';
export const TKG = () => {
